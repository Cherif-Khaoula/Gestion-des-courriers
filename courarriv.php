...
if (isset($_POST["submit"])) {
  ...
  $sql = "SELECT * FROM `courrierarrive` WHERE (envoyerpar = '$str' OR ref='$str' OR distination='$str' OR sousdistination='$str' OR objet='$str')  AND ( distination = '$sec_name' OR sousdistination  = '$sec_name') ";
...
$sql = "SELECT * FROM `courrierarrive` WHERE  (distination = '$sec_name' OR sousdistination  = '$sec_name')";
