...
if (isset($_POST["submit"])) {
  ...
  $sql = "SELECT * FROM `courrierarrive` WHERE (envoyerpar = '$str' OR ref='$str' OR distination='$str' OR sousdistination='$str' OR objet='$str')  AND (type='depart'AND `etat`='valider' AND (envoyerpar = '$sec_name')) ";
...
if ($result = mysqli_query($conn, $sql)) {
  ...
  while ($row = mysqli_fetch_row($result)) {?>
    ...
    <div class="outer">
      <div class="car" >
        <div class="content">
          <div class="img"><img src="vali.png" alt=""></div>
          <div class="details"><a href="cour.php?id=<?php echo $row[0] ; ?>">
            <span class="name"><?php echo $row[6] ; ?></span>
            <p><?php echo $row[9] ; ?></p><br>
            <a href="pdf.php?id=<?php echo $row[0] ; ?>"><?php echo $row[12] ; ?>
