...
if (isset($_POST["submit"])) {
  ...
  $sql = "SELECT * FROM `courrierarrive` WHERE (envoyerpar = '$str' OR ref='$str' OR distination='$str' OR sousdistination='$str' OR objet='$str')  AND (type='depart' AND etat='valider') ";
...
if ($result = mysqli_query($conn, $sql)) {
  // Fetch one and one row
    ...
    <div class="outer">
      <div class="car" >
        <div class="content">
          <div class="img"><img src="dep.png" alt=""></div>
