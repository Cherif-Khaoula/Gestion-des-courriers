...
if (isset($_POST["submit"])) {
  ...
  $sql = "SELECT * FROM `courrierarrive` WHERE (envoyerpar = '$str' OR ref='$str' OR distination='$str' OR sousdistination='$str' OR objet='$str')  AND (type = 'depart' AND  etat ='non valider') ";
      ...
      <div class="car" >
        <div class="content">
          ...
          <div class="details"><a href="cour.php?id=<?php echo $row[0] ; ?>">
            ...
            <a href="v.php?id=<?php echo $row[0] ; ?>"><img src="v.png" style=width:30px>
          </div></a>
        </div>
